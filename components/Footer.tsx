        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3">
              ...
              {/*
                Canonical page URL. Swap this for facebook.com/<username> once a
                page username is claimed — share links carry a rotating token and
                can stop resolving.
              */}
              <a
                href="https://www.facebook.com/profile.php?id=61574988510896"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-10 h-10 border border-white/15 flex items-center justify-center text-white/40 hover:text-[#00A896] hover:border-[#00A896] transition-colors"
