          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="w-10 h-10 border border-white/20 flex items-center justify-center text-white/60 hover:text-[#C8A96E] hover:border-[#C8A96E] transition-colors"
              >
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-[#C8A96E] hover:text-[#B8935A] transition-colors font-medium"
                >
                  Book Now &rarr;
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                ...
                <a
                  href="tel:7206778799"
                  className="text-sm text-white/60 hover:text-[#C8A96E] transition-colors block"
                >
                  720-677-8799
                </a>
              </li>
