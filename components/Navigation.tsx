          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-7">
              ...
              <a
                ...
                className="flex items-center gap-1.5 text-sm font-medium text-[#0F2240] hover:text-[#00A896] transition-colors"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <a
                href="https://www.facebook.com/profile.php?id=100088973471805"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="text-[#4A6583] hover:text-[#00A896] transition-colors"
