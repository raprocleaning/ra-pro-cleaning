      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="space-y-10 text-[#3A3A3A] text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0F2240] mb-3">1. Acceptance of Terms</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0F2240] mb-3">2. Services</h2>
              <p className="mb-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0F2240] mb-3">3. Booking &amp; Scheduling</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0F2240] mb-3">4. Cancellation &amp; Rescheduling</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0F2240] mb-3">6. Satisfaction Guarantee</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0F2240] mb-3">7. Access to Property</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0F2240] mb-3">8. Liability</h2>
              <p className="mb-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0F2240] mb-3">9. Website Use</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0F2240] mb-3">10. Intellectual Property</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0F2240] mb-3">11. Changes to Terms</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0F2240] mb-3">12. Governing Law</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0F2240] mb-3">14. Contact Us</h2>
              <p>If you have questions about these Terms of Service, please contact us:</p>
              <div className="mt-3 space-y-1">
                <p><strong>R A Pro Cleaning Services LLC</strong></p>
                <p>1325 S Colorado Blvd</p>
                <p>Denver, CO 80222</p>
