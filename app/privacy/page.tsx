      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 prose prose-gray max-w-none">
          ...
          <div className="space-y-10 text-[#3A3A3A] text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0A0A0A] mb-3">1. Introduction</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0A0A0A] mb-3">2. Information We Collect</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0A0A0A] mb-3">3. How We Use Your Information</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0A0A0A] mb-3">4. SMS Communications</h2>
              <p className="mb-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0A0A0A] mb-3">5. Sharing Your Information</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0A0A0A] mb-3">6. Cookies</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0A0A0A] mb-3">7. Data Security</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0A0A0A] mb-3">8. Your Rights</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0A0A0A] mb-3">9. Children&apos;s Privacy</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0A0A0A] mb-3">10. Changes to This Policy</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-[#0A0A0A] mb-3">11. Contact Us</h2>
