...
export default function ContactPage() {
  return (
    <main className="pt-20">
      ...
      {/* Quick Contact Bar */}
      <section className="py-10 bg-[#EBF4FF] border-b border-[#C8DFEF]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="w-12 h-12 bg-[#4A90D9] flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="font-bold text-[#1A2B4B] group-hover:text-[#4A90D9] transition-colors">
                  720-677-8799
                </p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <p className="font-bold text-[#1A2B4B] group-hover:text-[#4A90D9] transition-colors text-sm">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs font-semibold text-[#4A6583] uppercase tracking-wider">Visit Us</p>
                <p className="font-bold text-[#1A2B4B] text-sm">
      ...
      <section className="py-16 bg-[#EBF4FF]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-[#1A2B4B] mb-8 tracking-tight">Service Area</h2>
          <div className="w-full h-96 overflow-hidden border border-[#C8DFEF]">
            <iframe
      ...
      <section className="py-16 bg-white border-t border-[#C8DFEF]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-xl font-bold text-[#1A2B4B] mb-6">Business Hours</h3>
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.day} className="flex items-center justify-between border-b border-[#C8DFEF] pb-3">
                    <span className="text-[#4A6583] text-sm">{item.day}</span>
                    <span className="text-[#1A2B4B] font-medium text-sm">{item.hours}</span>
                  </div>
                ))}
              </div>
            </div>
            <div>
              <h3 className="text-xl font-bold text-[#1A2B4B] mb-6">Follow Us</h3>
              <div className="flex gap-4">
                <a
                  href="https://www.instagram.com/raprocleaningservice/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 border border-[#C8DFEF] px-5 py-3 hover:border-[#4A90D9] hover:text-[#4A90D9] transition-colors text-sm font-medium text-[#1A2B4B]"
                >
